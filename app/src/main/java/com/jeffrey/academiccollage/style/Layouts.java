...
public class Layouts extends BasicActivity {
...
// TODO: 15/12/2018 איתחול של אובייקט מסוג recycelviev
        ...
        ReceyclerViewMessageOnEachPage adapter = new ReceyclerViewMessageOnEachPage("Layouts");
    ...
    public void saveMessageOnFireBase(){
        ...
        db.collection("Layouts").add(allMessage.get(allMessage.size()-1)).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
            @Override
